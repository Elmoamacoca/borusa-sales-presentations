  ...
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex relative z-10">
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <p className="text-base md:text-lg font-light text-white leading-relaxed">
              Em vez de vendedor gastar tempo com curioso, o sistema separa cedo quem tem fit, quem deve ser nutrido e quem sai do jogo. Quando o lead chega no vendedor, já vem com contexto, prioridade e próximo passo recomendado.
            </p>
          </motion.div>
        </div>
        ...
        >
          <img
            src="/slide33-image.jpg"
            alt="Triagem Cirúrgica"
