...
export default function Veil13() {
  ...
  const ias = [
    { name: 'IA SDR', icon: Brain, color: '#a855f7' },
    { name: 'IA Compromisso', icon: Calendar, color: '#a855f7' },
    { name: 'IA Follow-up', icon: RefreshCw, color: '#a855f7' },
    { name: 'IA Estrategista', icon: Lightbulb, color: '#a855f7' }
  ];
          ...
          <div className="relative w-full max-w-lg h-full flex items-center justify-center px-12">
            ...
            <svg viewBox="0 0 300 400" className="w-full h-auto max-h-full">
              ...
              >
                ...
                >
                  <circle cx="90" cy="75" r="15" fill="#a855f7" fillOpacity="0.4"/>
                ...
                <text x="120" y="88" fill="#a855f7" fontSize="10" fontWeight="600" className="font-sans">Célula Términus</text>
              </motion.g>
              ...
              {ias.map((ia, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <line x1="100" y1={y + 26} x2="220" y2={y + 26} stroke="#a855f7" strokeWidth="1.5" opacity="0.5"/>
                    <line x1="100" y1={y + 32} x2="200" y2={y + 32} stroke="#a855f7" strokeWidth="1.5" opacity="0.4"/>
                    <line x1="100" y1={y + 38} x2="210" y2={y + 38} stroke="#a855f7" strokeWidth="1.5" opacity="0.3"/>
