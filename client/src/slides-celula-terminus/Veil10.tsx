    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex relative z-10">
        ...
        <div className="w-[60%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <span className="text-green-400 font-bold">IA DE FOLLOW-UP</span> <span className="text-white">–</span> NINGUÉM SOME DEPOIS DA PROPOSTA
          </motion.h1>
          ...
          >
            <p className="text-base md:text-lg font-light text-white leading-relaxed font-sans">
              A <span className="text-green-400 font-semibold">IA de Follow-up</span> entra em jogo depois que a proposta é enviada: ela puxa o lead de volta, responde dúvidas, insiste com inteligência e fecha o ciclo até o sim ou o não definitivo, sem depender da memória do vendedor.
            </p>
