            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">IA SDR:</span> entrada e triagem dos leads;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">IA de Compromisso:</span> agenda, lembretes e no-show;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">IA de Follow-up:</span> retomada, persistência e fechamento;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">IA Estrategista:</span> leitura do funil, insights e decisões.
                </p>
              </div>
            </div>
          </motion.div>
