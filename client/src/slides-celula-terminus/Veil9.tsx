    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex relative z-10">
        ...
        <div className="w-[60%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <span className="text-green-400 font-bold">IA DE COMPROMISSO</span> <span className="text-white">–</span> AGENDA CHEIA COM GENTE CERTA
          </motion.h1>
          ...
          >
            <p className="text-base md:text-lg font-light text-white leading-relaxed font-sans">
              A <span className="text-green-400 font-semibold">IA de Compromisso</span> assume a conversa quando o lead já está qualificado e leva até o agendamento: oferece horários, confirma, manda lembretes e prepara o terreno pro closer chegar na call sem surpresa.
            </p>
              ...
              <div className="space-y-2.5">
                {features.map((item, index) => (
                  <motion.div
                    ...
                    className="flex items-start gap-2.5 bg-green-400/5 border-l-2 border-green-400 pl-3 py-2 rounded-r"
                  >
