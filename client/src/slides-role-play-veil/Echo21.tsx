...
export default function Echo21() {
        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <p className="text-base md:text-lg lg:text-xl font-light text-white leading-relaxed mb-8">
              Durante os <span className="text-purple-400 font-semibold">9 meses de acompanhamento</span>, você tem acesso a:
            </p>
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">Reunião Mensal:</span> Acompanhamento dedicado de resultados e estratégia;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">QBR Trimestral:</span> Análise de ROI acumulado e roadmap futuro;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">Suporte 24/7:</span> Equipe exclusiva respondendo suas dúvidas;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">Borusa Academy:</span> Portal de vídeos e treinamentos contínuos.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="relative w-full max-w-lg px-12 py-16">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-purple-400/20 to-purple-600/10 border-2 border-purple-400 rounded-xl p-5 backdrop-blur-md"
