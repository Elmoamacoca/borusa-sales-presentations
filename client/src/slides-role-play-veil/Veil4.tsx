      ...
      <div className="w-full h-full flex flex-col items-center justify-center px-12 py-8">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-white mb-3 font-sans">
            CÉLULA TÉRMINUS – <span className="text-green-400">VEIL</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl w-full">
          ...
          >
            ...
            <div className="border-b-2 border-green-400 pb-3">
              ...
              <p className="text-gray-300 text-sm md:text-base leading-relaxed font-light font-sans">
                Eu entro no campo com você pra desenhar, configurar e conectar a refinaria de IA dentro do seu Inside Sales.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="border-b-2 border-green-400 pb-3">
              ...
              <p className="text-gray-300 text-sm md:text-base leading-relaxed font-light font-sans">
                IA SDR com Qualificação Básica, IA de Compromisso (lembrete e confirmação), IA de Follow-up com Persistência Estratégica, IA Estrategista com monitoramento contínuo, portal do cliente e conexões com WhatsApp, CRM e agenda.
              </p>
            </div>
          </motion.div>

          {/* Item 3 - Ajustes e Otimização */}
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <div className="border-b-2 border-green-400 pb-3">
              <h3 className="text-white text-base md:text-lg font-semibold mb-1.5 font-sans">
                Ajustes e otimização nos primeiros 90 dias
              </h3>
              <p className="text-gray-300 text-sm md:text-base leading-relaxed font-light font-sans">
                Refinamos mensagens, cadências, regras de triagem e indicadores até o fluxo rodar redondo em produção.
              </p>
            </div>
          </motion.div>
