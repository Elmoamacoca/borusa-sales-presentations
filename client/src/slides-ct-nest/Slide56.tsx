    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex relative z-10">
        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10 ml-[50%]">
          ...
          >
            <span className="text-yellow-400 font-bold">BÔNUS:</span> ARSENAL OPEN SOURCE "CAIXA DE PANDORA"
          </motion.h1>
          ...
          >
            <div className="bg-gradient-to-br from-yellow-400/10 to-yellow-600/5 border-2 border-yellow-400 rounded-xl px-8 py-6 backdrop-blur-sm shadow-lg shadow-yellow-400/20">
              ...
              <p className="text-4xl md:text-5xl font-bold text-yellow-400 font-sans">R$ 15.000,00</p>
            </div>
          </motion.div>
        </div>
      </div>
