        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <p className="text-base md:text-lg lg:text-xl font-light text-white leading-relaxed mb-8">
              Durante os <span className="text-yellow-400 font-semibold">9 meses de acompanhamento</span>, você tem acesso a:
            </p>
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-yellow-400">Reunião Mensal:</span> Acompanhamento dedicado de resultados e estratégia;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-yellow-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-yellow-400">QBR Trimestral:</span> Análise de ROI acumulado e roadmap futuro;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-yellow-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-yellow-400">Suporte 24/7:</span> Equipe exclusiva respondendo suas dúvidas;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-yellow-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-yellow-400">Borusa Academy:</span> Portal de vídeos e treinamentos contínuos.
                </p>
              </div>
            </div>
          </motion.div>
