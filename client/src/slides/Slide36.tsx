        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <p className="text-base md:text-lg font-light text-white leading-relaxed">
              O sistema mostra em que etapa o dinheiro está vazando: onde mais se perde lead, quais objeções travam e qual etapa alonga demais o ciclo. Decisão passa a ser tomada em cima de dado, não de achismo do time.
            </p>
          </motion.div>
        </div>
