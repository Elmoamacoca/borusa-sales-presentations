  ...
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex relative z-10">
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <p className="text-base md:text-lg font-light text-white leading-relaxed">
              Mensagens, cadências e horários não ficam congelados: o sistema testa variações, compara o resultado e promove o que performa melhor. A operação comercial melhora sozinha, sem refazer tudo do zero todo mês.
            </p>
          </motion.div>
        </div>
        ...
        >
          <img
            src="/slide37-image.jpg"
            alt="Sistema Que Evolui"
