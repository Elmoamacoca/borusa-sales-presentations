...
export default function Slide60Recorrencia() {
        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <p className="text-base md:text-lg lg:text-xl font-light text-white leading-relaxed mb-8">
              Sua vantagem competitiva está <span className="text-yellow-400 font-semibold">protegida e blindada</span>:
            </p>
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-yellow-400">Memória da Operação:</span> Toda base de conhecimento é seu ativo exclusivo;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-yellow-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-yellow-400">Custo de Reconstrução:</span> Reconstruir essa base em outro lugar é gigantesco;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-yellow-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-yellow-400">Propriedade Intelectual:</span> Toda tecnologia é propriedade Borusa;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-yellow-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-yellow-400">Crescimento Contínuo:</span> Você fica mais forte a cada mês.
                </p>
              </div>
            </div>
          </motion.div>
