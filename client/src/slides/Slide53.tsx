    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex relative z-10">
        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <span className="text-yellow-400 font-bold">TRILHA DE VÍDEOS:</span> PORTAL E PAINÉIS
          </motion.h1>
          ...
          <div className="relative w-full max-w-lg h-full flex items-center justify-center px-12">
            ...
            <svg viewBox="0 0 300 400" className="w-full h-auto max-h-full">
              ...
              >
                ...
                >
                  <circle cx="150" cy="105" r="25" fill="#d4a017" fillOpacity="0.3" stroke="#d4a017" strokeWidth="2"/>
                  <polygon points="145,95 145,115 165,105" fill="#ffffff"/>
                </motion.g>
                
                {/* Label */}
                <text x="150" y="190" textAnchor="middle" fill="#d4a017" fontSize="10" fontWeight="700" className="font-sans">
                  VÍDEO TUTORIAL
                </text>
              </motion.g>
              ...
              {[
                ...
                >
                  ...
                  {/* Ícone */}
                  <circle cx="95" cy={panel.y + 22} r="12" fill="#d4a017" fillOpacity="0.3"/>
