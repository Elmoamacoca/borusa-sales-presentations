...
export default function Echo24() {
        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <p className="text-base md:text-lg lg:text-xl font-light text-white leading-relaxed mb-8">
              Vamos <span className="text-purple-400 font-semibold">crescer juntos</span> nos próximos 9 meses:
            </p>
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">Suporte Exclusivo:</span> Equipe dedicada ao seu sucesso;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">Evolução Contínua:</span> Sistema sempre melhorando com releases semanais;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">Proteção Garantida:</span> Sua base de conhecimento é seu ativo;
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-purple-400 mt-2"></div>
                <p className="text-base md:text-lg font-light text-white leading-relaxed">
                  <span className="font-semibold text-purple-400">Crescimento Exponencial:</span> Cada mês mais eficiente e lucrativo.
                </p>
              </div>
            </div>
          </motion.div>
