    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex relative z-10">
        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <span className="text-green-400 font-bold">IA SDR</span> <span className="text-white">–</span> SUA PORTA DE ENTRADA INTELIGENTE
          </motion.h1>
          ...
          >
            <p className="text-base md:text-lg font-light text-white leading-relaxed font-sans">
              A <span className="text-green-400 font-semibold">IA SDR</span> é a IA que recebe todo lead que entra, entende quem ele é, por que chegou até você e se faz sentido seguir adiante. Ela limpa a bagunça da entrada e garante que só chega no vendedor quem tem contexto mínimo e fit inicial.
            </p>

            <div>
              <p className="text-base md:text-lg font-semibold text-green-400 mb-5 font-sans">
              ...
              <div className="space-y-4">
                {features.map((item, index) => (
                  <motion.div
                    ...
                    className="flex items-start gap-3 bg-green-400/5 border-l-2 border-green-400 pl-4 py-2.5 rounded-r"
                  >
