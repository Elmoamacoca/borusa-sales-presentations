...
export default function Echo11() {
    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex relative z-10">
        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <span className="text-purple-400 font-bold">IA ESTRATEGISTA</span> <span className="text-white">–</span> O CÉREBRO TÁTICO
          </motion.h1>
          ...
          >
            <p className="text-base md:text-lg font-light text-white leading-relaxed font-sans">
              A <span className="text-purple-400 font-semibold">IA Estrategista</span> não fala com cliente. Ela observa o funil, lê os números e mostra onde o time está vazando dinheiro. Em cima disso, sugere o que testar, o que ajustar e o que parar de fazer.
            </p>
