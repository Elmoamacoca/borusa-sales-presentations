...
// Import slides
import WelcomeSlide from '@/slides-ct-veil/WelcomeSlide';
import MatheusFielSlide from '@/slides-ct-veil/MatheusFielSlide';
import Slide2022 from '@/slides-ct-veil/Slide2022';
import Slide2025 from '@/slides-ct-veil/Slide2025';
import MissionSlide from '@/slides-ct-veil/MissionSlide';
import MethodologySlide from '@/slides-ct-veil/MethodologySlide';
import HydraNetSlide from '@/slides-ct-veil/HydraNetSlide';
import AdaptedLogicSlide from '@/slides-ct-veil/AdaptedLogicSlide';
import JourneySlide from '@/slides-ct-veil/JourneySlide';
import ResultsSlide from '@/slides-ct-veil/ResultsSlide';
import ObstaclesSlide from '@/slides-ct-veil/ObstaclesSlide';
import OtimizacaoTempoSlide from '@/slides-ct-veil/OtimizacaoTempoSlide';
import InvestimentoSlide from '@/slides-ct-veil/InvestimentoSlide';
import Investimento2Slide from '@/slides-ct-veil/Investimento2Slide';
import EstruturaSlide from '@/slides-ct-veil/EstruturaSlide';
import PerguntaIASlide from '@/slides-ct-veil/PerguntaIASlide';
import Investimento3Slide from '@/slides-ct-veil/Investimento3Slide';
import Investimento4Slide from '@/slides-ct-veil/Investimento4Slide';
import OtimizacaoTempo2Slide from '@/slides-ct-veil/OtimizacaoTempo2Slide';
import Slide20 from '@/slides-ct-veil/Slide20';
import Slide21 from '@/slides-ct-veil/Slide21';
import Slide22 from '@/slides-ct-veil/Slide22';
import Slide23 from '@/slides-ct-veil/Slide23';
import Slide24 from '@/slides-ct-veil/Slide24';
import Slide25 from '@/slides-ct-veil/Slide25';
import Slide26 from '@/slides-ct-veil/Slide26';
import Slide27 from '@/slides-ct-veil/Slide27';
import Slide28 from '@/slides-ct-veil/Slide28';
import Slide29 from '@/slides-ct-veil/Slide29';
import Slide30 from '@/slides-ct-veil/Slide30';

import Slide32 from '@/slides-ct-veil/Slide32';
import Slide33 from '@/slides-ct-veil/Slide33';
import Slide34 from '@/slides-ct-veil/Slide34';
import Slide35 from '@/slides-ct-veil/Slide35';
import Slide36 from '@/slides-ct-veil/Slide36';
import Slide37 from '@/slides-ct-veil/Slide37';
import Slide38 from '@/slides-ct-veil/Slide38';
import Slide39 from '@/slides-ct-veil/Slide39';
import Slide40 from '@/slides-ct-veil/Slide40';
import Slide41 from '@/slides-ct-veil/Slide41';
import Slide42 from '@/slides-ct-veil/Slide42';
import Slide43 from '@/slides-ct-veil/Slide43';
import Slide44 from '@/slides-ct-veil/Slide44';
import Slide45 from '@/slides-ct-veil/Slide45';
import Slide46 from '@/slides-ct-veil/Slide46';
import Slide47 from '@/slides-ct-veil/Slide47';
import Slide48 from '@/slides-ct-veil/Slide48';
import Slide49 from '@/slides-ct-veil/Slide49';
import Slide50 from '@/slides-ct-veil/Slide50';
import Slide51 from '@/slides-ct-veil/Slide51';
import Slide52 from '@/slides-ct-veil/Slide52';
import Slide53 from '@/slides-ct-veil/Slide53';
import Slide54 from '@/slides-ct-veil/Slide54';
import Slide55 from '@/slides-ct-veil/Slide55';
import Slide56 from '@/slides-ct-veil/Slide56';
import Slide57 from '@/slides-ct-veil/Slide57';
import Slide57Recorrencia from '@/slides-ct-veil/Slide57Recorrencia';
import Slide58 from '@/slides-ct-veil/Slide58';
import Slide58Recorrencia from '@/slides-ct-veil/Slide58Recorrencia';
import Slide59Recorrencia from '@/slides-ct-veil/Slide59Recorrencia';
import Slide59 from '@/slides-ct-veil/Slide59';
import Slide60Recorrencia from '@/slides-ct-veil/Slide60Recorrencia';
import Slide60 from '@/slides-ct-veil/Slide60';
import Slide61Recorrencia from '@/slides-ct-veil/Slide61Recorrencia';
import Slide61 from '@/slides-ct-veil/Slide61';
import Slide62Recorrencia from '@/slides-ct-veil/Slide62Recorrencia';
import Slide62 from '@/slides-ct-veil/Slide62';
import Slide63 from '@/slides-ct-veil/Slide63';
import Slide64 from '@/slides-ct-veil/Slide64';
import Slide65 from '@/slides-ct-veil/Slide65';
import Slide66 from '@/slides-ct-veil/Slide66';
import Slide67 from '@/slides-ct-veil/Slide67';
import Slide68 from '@/slides-ct-veil/Slide68';
import Slide69 from '@/slides-ct-veil/Slide69';
import Veil2 from '@/slides-ct-veil/Veil2';
import Veil3 from '@/slides-ct-veil/Veil3';
import Veil4 from '@/slides-ct-veil/Veil4';
import Veil5 from '@/slides-ct-veil/Veil5';
import Veil6 from '@/slides-ct-veil/Veil6';
import Veil7 from '@/slides-ct-veil/Veil7';
import Veil8 from '@/slides-ct-veil/Veil8';
import Veil9 from '@/slides-ct-veil/Veil9';
import Veil10 from '@/slides-ct-veil/Veil10';
import Veil11 from '@/slides-ct-veil/Veil11';
import Veil12 from '@/slides-ct-veil/Veil12';
import Veil13 from '@/slides-ct-veil/Veil13';
import Veil14 from '@/slides-ct-veil/Veil14';
import Veil15 from '@/slides-ct-veil/Veil15';
import Veil16 from '@/slides-ct-veil/Veil16';
import Veil17 from '@/slides-ct-veil/Veil17';
import Veil18 from '@/slides-ct-veil/Veil18';
import Veil19 from '@/slides-ct-veil/Veil19';
import Veil20 from '@/slides-ct-veil/Veil20';
import Veil21 from '@/slides-ct-veil/Veil21';
import Veil22 from '@/slides-ct-veil/Veil22';
import Veil24 from '@/slides-ct-veil/Veil24';
import Echo2 from '@/slides-ct-veil/Echo2';
import Echo3 from '@/slides-ct-veil/Echo3';
import Echo4 from '@/slides-ct-veil/Echo4';
import Echo5 from '@/slides-ct-veil/Echo5';
import Echo6 from '@/slides-ct-veil/Echo6';
import Echo7 from '@/slides-ct-veil/Echo7';
import Echo8 from '@/slides-ct-veil/Echo8';
import Echo9 from '@/slides-ct-veil/Echo9';
import Echo10 from '@/slides-ct-veil/Echo10';
import Echo11 from '@/slides-ct-veil/Echo11';
import Echo12 from '@/slides-ct-veil/Echo12';
import Echo13 from '@/slides-ct-veil/Echo13';
import Echo14 from '@/slides-ct-veil/Echo14';
import Echo15 from '@/slides-ct-veil/Echo15';
import Echo16 from '@/slides-ct-veil/Echo16';
import Echo17 from '@/slides-ct-veil/Echo17';
import Echo18 from '@/slides-ct-veil/Echo18';
import Echo20 from '@/slides-ct-veil/Echo20';
import Echo21 from '@/slides-ct-veil/Echo21';
import Echo22 from '@/slides-ct-veil/Echo22';
import Echo24 from '@/slides-ct-veil/Echo24';
...
export const ctVeilSlidesConfig: SlideDefinition[] = [
