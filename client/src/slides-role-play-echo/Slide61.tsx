  ...
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="w-full h-full flex items-center justify-center gap-20 px-16 relative z-10">
        ...
        >
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-light text-purple-400 font-sans leading-tight">
            QUANTO<br />VALE?
          </h1>
        </motion.div>
        ...
        >
          <motion.div
            ...
            className="text-[20rem] font-bold text-purple-400 leading-none"
