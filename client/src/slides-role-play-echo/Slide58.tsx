        ...
        >
          <div className="grid grid-cols-2 gap-x-32 gap-y-5 mx-auto">
            {etapas.map((etapa, index) => (
              ...
              >
                {/* Círculo com número */}
                <div className="flex-shrink-0 w-14 h-14 rounded-full bg-gradient-to-br from-purple-400 to-purple-500 flex items-center justify-center border-3 border-white/20">
                  <span className="text-lg font-bold text-white">{etapa.numero}</span>
                </div>

                {/* Conteúdo */}
                <div className="flex-1 max-w-[280px]">
                  <div className="inline-block bg-purple-400/20 px-3 py-1 rounded-full mb-1.5">
