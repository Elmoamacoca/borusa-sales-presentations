        ...
        <div className="w-[50%] h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 relative z-10">
          ...
          >
            <p className="text-base md:text-lg font-light text-white leading-relaxed">
              Leads entram por qualquer canal e sempre encontram resposta rápida, próximo passo claro e registro automático. Nada fica perdido em conversa solta ou na cabeça de alguém: o caminho até a agenda flui sem buracos.
            </p>
          </motion.div>
        </div>
